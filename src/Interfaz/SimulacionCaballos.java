...
public class SimulacionCaballos extends javax.swing.JFrame {
    ...
    private void InicioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InicioActionPerformed
        ...
        Carrera hilo5 = new Carrera(Caballo5, this);
        Carrera hilo6 = new Carrera(Caballo6, this);
        Carrera hilo7 = new Carrera(Caballo7, this);
        Carrera hilo8 = new Carrera(Caballo8, this);
        Carrera hilo9 = new Carrera(Caballo9, this);
        Carrera hilo10 = new Carrera(Caballo10, this);
        hilo1.start();
        hilo2.start();
        hilo3.start();
        hilo4.start();
