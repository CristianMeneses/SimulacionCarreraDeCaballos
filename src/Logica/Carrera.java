        ...
        while (true) {
            try {
                ...
                if (c1 < p.getMeta().getLocation().x - 10 && c2 < p.getMeta().getLocation().x - 10
                    ...
                    p.Caballo1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/" + i + ".jpg")));
                    p.Caballo2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/" + i + ".jpg")));
                    p.Caballo3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/" + i + ".jpg")));
                    p.Caballo4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/" + i + ".jpg")));
                    p.Caballo5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/" + i + ".jpg")));
                    p.Caballo6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/" + i + ".jpg")));
                    p.Caballo7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/" + i + ".jpg")));
                    p.Caballo8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/" + i + ".jpg")));
                    p.Caballo9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/" + i + ".jpg")));
                    p.Caballo10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/" + i + ".jpg")));
